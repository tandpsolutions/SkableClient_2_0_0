...
public class OrderBookView extends javax.swing.JInternalFrame {
    ...
    private void setData(String from_date, String to_date, String branch_cd) {
        try {
            ...
            JsonObject call = orderBookAPI.GetOrderBookHeader(from_date, to_date, branch_cd, "", "", "","", SkableHome.selected_year).execute().body();
                    ...
                    if (row != -1) {
                        ...
                        if (lb.type) {
                            try {
                                ...
                                JsonObject object = orderBookAPI.DeleteOrderBookEntry(ref_no, "", SkableHome.selected_year).execute().body();
