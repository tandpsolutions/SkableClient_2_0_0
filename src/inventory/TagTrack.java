...
public class TagTrack extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Voucher No", "Book", "Party Name", "Issue", "Reciept", "Balance", "TAG", "ref_no"
            }
        ) {
            ...
            if (rspns.isSuccessful()) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < array.size(); i++) {
                        ...
                        row.add(array.get(i).getAsJsonObject().get("doc_ref_no").getAsString());
                        jtxtBranch.setText(Constants.BRANCH.get(array.get(i).getAsJsonObject().get("BRANCH_CD").getAsInt() - 1).getBranch_name());
                        dtm.addRow(row);
                    }
...
// TODO add your handling code here:
    ...
    if (row != -1) {
        ...
        pp.getSalesBillPrint(jTable1.getValueAt(row, 8).toString());
        pp.setVisible(true);
    }
