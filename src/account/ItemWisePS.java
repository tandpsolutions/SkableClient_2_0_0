...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SR No", "Name", "Date", "Item Name", "IMEI", "Rate", "Sale Rate", "Profit"
            }
        ) {
        ...
        jCheckBox3.setText("Bill Number");
    ...
    private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
        try {
            ...
            JsonObject call = accountAPI.IMEWisePS(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                    lb.ConvertDateFormetForDB(jtxtToDate.getText()), model_cd, ac_cd, type_cd, brand_cd, bill_no).execute().body();
            if (call != null) {
                JsonObject result = call;
                if (result.get("result").getAsInt() == 1) {
                    JsonArray array = call.getAsJsonArray("data");
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        ...
                        tot1 += lb.isNumber(jTable1.getValueAt(i, 6).toString());
                        tot2 += lb.isNumber(jTable1.getValueAt(i, 7).toString());
                    }
