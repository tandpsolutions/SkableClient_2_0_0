...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ref_no", "Type", "Bill No", "Date", "Name", "Code", "Brand", "Name", "IMEI", "Serail No", "Qty", "Rate", "Basic Item Amt", "Amt", "Basic Amt", "Tax", "Tax Amt", "Add tax Amt", "Net Amt", "Tax Name", "Cash", "Bank", "Card", "Buy Back Amt", "Buy Back Model", "Bajaj Amt", "Insurance Amt", "Debtors", "Branch"
            }
        ) {
