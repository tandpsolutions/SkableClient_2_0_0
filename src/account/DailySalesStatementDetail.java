    ...
    private void makeQuery() {
        try {
            ...
            if (result.get("result").getAsInt() == 1) {
                ...
                double net = 0.00, insurance = 0.00, buy_back = 0.00, cash = 0.00, card = 0.00, bank = 0.00, debtors = 0.00, bajaj = 0.00,
                        discount = 0.00, mop = 0.00;
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    cash += lb.isNumber2(jTable1.getValueAt(i, 5).toString());
                    bank += lb.isNumber2(jTable1.getValueAt(i, 6).toString());
                    card += lb.isNumber2(jTable1.getValueAt(i, 7).toString());
                    bajaj += lb.isNumber2(jTable1.getValueAt(i, 10).toString());
                    buy_back += lb.isNumber2(jTable1.getValueAt(i, 11).toString());
                    insurance += lb.isNumber2(jTable1.getValueAt(i, 12).toString());
                    debtors += lb.isNumber2(jTable1.getValueAt(i, 13).toString());
                    net += lb.isNumber2(jTable1.getValueAt(i, 14).toString());
                    mop += lb.isNumber2(jTable1.getValueAt(i, 15).toString());
                }
                ...
                row.add(lb.Convert2DecFmtForRs(mop));
                dtm.addRow(row);
